namespace Core;
public record TargetOptions(bool Enabled, Box Box, Tracer Tracer = default)
{
    static AABB
    ...
    public static implicit operator TargetOptions((bool Enalbed, Box Box) args) => new(args.Enalbed, args.Box);
    public static implicit operator TargetOptions((bool Enalbed, Box Box, Tracer Tracer) args) => new(args.Enalbed, args.Box, args.Tracer);
}